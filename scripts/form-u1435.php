...
{
	$to = 'ralphbarberjr@fitted4fitness.com';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U1463"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U1458"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Cell Phone:</b></td><td>' . htmlentities($_REQUEST["custom_U1472"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Home Phone:</b></td><td>' . htmlentities($_REQUEST["custom_U1478"],ENT_COMPAT,'UTF-8') . '</td></tr>';
